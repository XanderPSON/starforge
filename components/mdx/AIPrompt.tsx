...
export function AIPrompt({ prompt, className }: AIPromptProps) {
  ...
  return (
    <div 
      ...
      onClick={handleCopy}
    >
      <div className="flex items-center px-4 py-3 bg-gradient-to-r from-purple-600 to-violet-600 dark:from-purple-900/90 dark:to-violet-900/90 text-white gap-3 border-b border-purple-700/50 dark:border-purple-950">
        <button
          type="button"
          onClick={handleCopy}
          className={cn(
            'p-1.5 -ml-1.5 rounded-md',
      ...
      <div className="p-6 bg-purple-50/50 dark:bg-[#130d1c] text-gray-800 dark:text-purple-100/90 leading-relaxed font-sans whitespace-pre-wrap">
        {prompt}
      </div>
    </div>
  )
